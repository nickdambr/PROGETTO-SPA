...
%input
SigmaValue=sigma;
Beta075Value=beta; %ai 3/4 del raggio pala
Jloc=J;
...
Value = integral(@(x)Func(x,.1/pi,SigmaValue,Beta075Value),.15,1);


 

CT=integral(@(x)Func(x,Jloc/pi,SigmaValue,Beta075Value),.15,1);
